      ...
      <div className="grid min-h-[calc(100vh-40px)] w-full max-w-[1530px] overflow-hidden rounded-[22px] bg-white shadow-[0_20px_60px_rgba(50,25,20,.15)] lg:mx-auto lg:grid-cols-[48%_52%]">
        <section className="relative hidden overflow-hidden bg-gradient-to-br from-[#7b1725] via-[#65101c] to-[#4b0911] px-[6%] py-[5%] text-white lg:block">
          ...
          <div className="absolute bottom-20 left-0 w-full text-center">
            ...
            <p className="text-xs text-white/60">Bigger Tomorrow - KhataOne</p>
          </div>
        </section>
          ...
          <div className="flex flex-1 items-center justify-center py-8">
            <div className="w-full max-w-[500px]">
              ...
              <form onSubmit={signup} className="space-y-3">
                {[
                  { icon: UserRound, placeholder: "Full Name", type: "text" },
                  { icon: Mail, placeholder: "Email address", type: "email" },
                ].map(({ icon: Icon, placeholder, type }) => (
                  <div
                    key={placeholder}
                    className="flex h-[56px] items-center rounded-xl border border-[#ddd8d2] bg-white px-5 shadow-sm"
                  >
                    <Icon
                      size={18}
                      strokeWidth={1.8}
                ...
                {[
                  ...
                  >
                    ...
                    <button
                      type="button"
                      aria-label={
                        show ? `Hide ${placeholder}` : `Show ${placeholder}`
                      }
                ...
                <label className="flex items-center gap-2 pt-2 text-[12px] text-[#596473]">
                  ...
                  />
                  I agree to the{" "}
                  <button type="button" className="font-bold text-[#741421]">
                    Terms of Service
                  </button>{" "}
                  and{" "}
                  <button type="button" className="font-bold text-[#741421]">
