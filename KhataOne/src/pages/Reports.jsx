...
export default function Reports() {
  ...
  const exportCsv = () => {
    ...
    link.download = "khataone-report.csv";
    link.click();
  };
  return (
    <Heading
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {[
          ...
          <div
            className="rounded-xl border border-[#ebe7e3] bg-white p-5 dark:border-[#423238] dark:bg-[#2b2226]"
            key={name}
          >
            ...
            <strong className="mt-5 block text-sm text-[#8b8383]">
